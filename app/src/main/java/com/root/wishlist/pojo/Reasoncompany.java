...
import com.root.wishlist.pojo.profile.Device;

import java.util.ArrayList;
import java.util.List;

public class Reasoncompany {
    ...
    public Reasoncompany(String handle, String businessDiscussion, String businessAdditional) {
        this.handle = handle;
        this.businessAdditional = businessAdditional;
        this.businessDiscussion = businessDiscussion;
