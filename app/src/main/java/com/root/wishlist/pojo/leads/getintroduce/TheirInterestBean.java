...
public class TheirInterestBean {
    ...
    public TheirInterestBean(String handle, String shortBio, String bio, String image, String businessDiscussion, String businessAdditional) {
        this.handle = handle;
        this.shortBio = shortBio;
        this.bio = bio;
        this.image = image;
